...
struct ConfigControls {
	...
	init(inThisScene: ConfigScene) {
		...
		/// Title Label
		titleLabel = SKLabelNode.init(text: "Config Scene")
		titleLabel.name = "titleLabel-Config"
		...
		buttonSprite.name = "buttonSprite-Config"
		...
		buttonLabel.name = "buttonLabel-Config"
